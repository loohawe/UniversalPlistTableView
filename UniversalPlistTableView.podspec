...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UniversalPlistTableView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/loohawe@gmail.com/UniversalPlistTableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'loohawe@gmail.com' => 'luhao@mogoroom.com' }
  s.source           = { :git => 'https://github.com/loohawe@gmail.com/UniversalPlistTableView.git', :tag => s.version.to_s }
